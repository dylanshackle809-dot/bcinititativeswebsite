        ...
        <section className="section" id="privacy">
          <Reveal>
            ...
            <p className="partners-intro">
              Summit Seeker is a student-led project. We keep data collection to the minimum needed to
              run the site, we never sell it, and we don't use third-party ad tracking. Here's exactly
              what that means.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div style={{ maxWidth: "70ch", lineHeight: 1.65, marginTop: "1.5rem", display: "flex", flexDirection: "column", gap: "1.75rem" }}>
              ...
              <div>
                ...
                <p>
                  We use <strong>Vercel Analytics</strong> to understand aggregate traffic — things like how
                  many people visit and which pages are popular. This is anonymized and does not collect
                  personal data or build a profile of you. We don't use advertising cookies or third-party
                  ad trackers.
                </p>
              </div>
