  ...
  return (
    <article className={`hp-card ${featured ? "hp-card--featured" : ""}`}>
      ...
      <div className="hp-links">
        ...
        {p.website && (
          <a
            className="hp-social hp-social--site"
            href={siteUrl(p.website)}
            target="_blank"
            rel="noreferrer"
...
export function PartnerDirectory() {
  ...
  const ordered = useMemo(
    () =>
      [...partners].sort(
        (a, b) => (a.region === "BC/Canada" ? 0 : 1) - (b.region === "BC/Canada" ? 0 : 1),
      ),
    [],
  );
